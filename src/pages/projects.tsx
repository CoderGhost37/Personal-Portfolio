  ...
  return (
    <div className='w-full relative flex items-center justify-between rounded-3xl rounded-br-2xl border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl p-6 lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
      ...
      <div className='w-1/2 lg:w-full lg:pl-0 lg:pt-6 flex flex-col justify-between items-start pl-8'>
        ...
        >
          <h2 className='md:my-1 my-2 dark:text-light w-full text-left font-bold text-3xl sm:text-xl xs:text-base'>
            {title}
          </h2>
        </Link>
        <p className='md:my-1 my-2 font-medium text-dark dark:text-light text-lg md:text-base sm:text-sm xs:text-xs'>
          {description}
        </p>
...
const ProjectCard = ({
  ...
  return (
    <div className='w-full h-full flex flex-col justify-between rounded-3xl border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl p-6 xs:p-4 relative'>
      <div className='overflow-hidden'>
        ...
        <div className='w-full mt-5 flex flex-col justify-between items-start'>
          <Link
            ...
            className='hover:underline underline-offset-2'
          >
            <h2 className='md:my-1 my-2 w-full text-left font-bold dark:text-light text-3xl sm:text-xl xs:text-base'>
              {title}
            </h2>
          </Link>
          <p className='md:my-1 my-2 font-medium text-dark dark:text-light text-lg lg:text-base sm:text-sm xs:text-xs'>
            {description}
          </p>
        </div>
        <div className='flex flex-wrap items-center md:my-2 gap-2'>
          {tags?.map((tag, index) => (
            <span
              key={index}
              className='text-light bg-gray-500  py-1 px-2 rounded-lg text-sm sm:text-xs font-semibold'
    ...
    <div>
      ...
      <main className='w-full max-w-7xl mx-auto mb-16 flex flex-col items-center justify-center'>
        <Layout classStyles='pt-16'>
          ...
          />
          <div className='grid grid-cols-12 gap-20 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-20 sm:gap-x-0'>
